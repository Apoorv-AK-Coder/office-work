...
namespace EL.Offer
{
    ...
    public class HomePageTopOffer
    {
        ...
        {
            List<EL.Offer.BannerUpload> _BannerUpload = new List<BannerUpload>();
            List<EL.Offer.TopOfferFare> _TopOfferFare = new List<TopOfferFare>();
            if (ds != null)
            {
                if (ds.Tables[0] != null)
                {
        ...
        public List<EL.Offer.BannerUpload> BannerUpload { set; get; }
        public List<EL.Offer.TopOfferFare> TopOfferFare { set; get; }
