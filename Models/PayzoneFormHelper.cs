...
namespace TravelSite.Models
{
    ...
    public class PayzoneFormHelper
    {
                                                  ...
                                                  HASH_METHOD hmHashMethod)
        {
            ...
            sbReturnString.AppendFormat("MerchantID={0}&Password={1}&Amount={2}&CurrencyCode={3}&OrderID={4}&TransactionType={5}" +
                                        "&TransactionDateTime={6}&CallbackURL={7}&OrderDescription={8}&CustomerName={9}" +
                                        "&Address1={10}&Address2={11}&Address3={12}&Address4={13}&City={14}&State={15}&PostCode={16}" +
                                        "&CountryCode={17}&CV2Mandatory={18}&Address1Mandatory={19}&CityMandatory={20}" +
                                        "&PostCodeMandatory={21}&StateMandatory={22}&CountryMandatory={23}&ResultDeliveryMethod={24}" +
                                        "&ServerResultURL={25}&PaymentFormDisplaysResult={26}&ServerResultURLCookieVariables=" +
                                        "&ServerResultURLFormVariables=&ServerResultURLQueryStringVariables=&ThreeDSecureOverridePolicy=True&EchoThreeDSecureAuthenticationCheckResult=True",
                                                  ...
                                                  HASH_METHOD hmHashMethod)
        {
            ...
            sbReturnString.AppendFormat("MerchantID={0}&Password={1}&StatusCode={2}&Message={3}" +
                                        ...
                                        "&State={19}&PostCode={20}&CountryCode={21}&ThreeDSecureOverridePolicy=true&EchoThreeDSecureAuthenticationCheckResult=true",
